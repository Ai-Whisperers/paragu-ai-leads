...
## Pitch Completo (llamada o presencial)
...
- No tenés forma de mostrar todo tu catálogo de 200 productos ordenadamente
- Si alguien busca en Google "carpa para camping Paraguay", no te encuentra"

**La Solución**

"Nosotros creamos una tienda online para El Viajero. Ya tenemos todo listo. Funciona así:
...
**La Oferta (Primer Cliente)**

"Estamos buscando nuestro primer caso de éxito en e-commerce para mostrar a otros negocios. Elegimos El Viajero porque tienen un catálogo variado y local físico — el perfil ideal.

Por eso te hacemos esta oferta única:

- Setup completo: 0 Gs (normalmente 450.000 Gs)
- 3 meses completamente gratis
- Recién desde el mes 4: 639.000 Gs/mes

Tu tienda online funcionando desde hoy sin pagar nada hasta dentro de 3 meses."

**El Intercambio**

"A cambio, solo pedimos:
1. Que nos cuentes tu experiencia honesta
2. Un video de 30 segundos diciendo "estoy contento con mi tienda online, me la hicieron en 48 horas"
3. Permitirnos mostrar El Viajero como caso de estudio (sin costo para vos)

Nada más. Sin contratos rígidos, sin permanencia."

**Cierre**

"Ya tenemos la tienda armada con tus productos. En 48 horas está en línea. ¿Te parece si te la muestro ahora y ves qué tal queda?"
...
**"Y si no funciona"**
"Cancelás cuando quieras. Los primeros 3 meses son gratis — no perdés nada. Si después de 3 meses no ves resultados, no renovás."

**"Por qué tan barato los primeros meses?"**
"Porque queremos demostrar que funciona. Preferimos que seas vos quien nos recomiende a ganar plata el primer mes."

---

## URLs a mostrar

- Tienda: el-viajero.paragu-ai.com
- Catálogo de productos: el-viajero.paragu-ai.com/tienda

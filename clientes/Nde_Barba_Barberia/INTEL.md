# INTEL — Nde Barba Barbería
## Lead #8 — SECONDARY PRIORITY
...
- **Category:** Barbershop
- **Google Maps:** 4.8⭐ · 118 reviews
- **Distance from FP:** 1.7km
- **Website:** NONE
- **IG:** NOT FOUND — deep search returned no active IG handle
- **Score:** 92.6
...
### Instagram
- **Status:** NOT FOUND on Instagram (search returned no match)
...
- **Action required:** Facebook search with phone number: 0991 444 268

---

## SERVICES (from Google Maps)
- Barbershop services: haircuts, beard grooming, shaves
- Possibly: hair coloring for men, facial treatments
- "Nde Barba" = Guaraní-inspired name = LOCAL AUTHENTIC brand

---

## MARKET CONTEXT — Barbería Landscape in Paraguay
- **Los Barberos de López** = dominant player with website, membership model (G. 150,000/month unlimited), 24h service
- **Barberías in Fernando/San Lorenzo:** many small shops, most without web
- **Competition has website:** Los Barberos de López (barberos.com.py), Almacén del Barbero (alamcendelbarbero.com.py), Boedo, etc.
- **Opportunity:** Barbershops WITHOUT web in this area = untapped market for AI-Whisperers

# PAGE BUILDER — Cola de leads por sesión

## Cómo funciona
1. Elegís el lead más prioritario de la cola
2. Abrís la sesión → leés INTEL.md + PROPUESTA.md
3. Arrancás a construir desde lo documentado
4. Al cerrar sesión: push al repo del cliente, actualizá COLA.md
...
- Status: [PENDIENTE|EN_PROGRESO|ENTREGADO]
- Notas: [especialidades, photos known, etc]
```

## Leads pendientes — orden por score
...
- Notas: 392 reviews, negocio establecido, público definido. Galería de trabajos + booking + Instagram feed integrado. 5 estrellas.
- Status: **PENDIENTE**
- Sesión sugerida: #1
...
- Notas: 287 reviews, 4.9⭐, mejor rating de la zona. Celestial by Celeste = producto propio (vender online?). Instagram activo.
- Status: **PENDIENTE**
- Sesión sugerida: #2
...
- Notas: Gimnasio cerca de Politécnica, 119 reviews, oportunidad de mostrar equipos/horarios/planes. Sin web.
- Status: **PENDIENTE**
- Sesión sugerida: #3
...
- Notas: 118 reviews, barbería de barrio. Necesita mapa con cómo llegar. Booking online.
- Status: **PENDIENTE**
- Sesión sugerida: #4
...
- Notas: Gimnasio cerca de Politécnica, 51 reviews pero 4.9⭐. Brand premium.
- Status: **PENDIENTE**
- Sesión sugerida: #5
...
- Notas: 162 reviews, LA barbería más popular de la zona. Potencial membresía/reservas. Address: Av. Santa Teresa.
- Status: **PENDIENTE**
- Sesión sugerida: #6
...
- Notas: 206 reviews, tiene tienda de productos. E-commerce + servicios.
- Status: **PENDIENTE**
- Sesión sugerida: #7
...
- Notas: 5.0⭐ PERFECTO pero solo 24 reviews = operación pequeña. Jacarandá San Lorenzo = zona premium. Caso estudio 100% digital.
- Status: **PENDIENTE**
- Sesión sugerida: #8
...
- Notas: Muy cerca de Politécnica (1km), 92 reviews, 4.8⭐. Buena oportunidad local.
- Status: **PENDIENTE**
- Sesión sugerida: #9
...
- Notas: 233 reviews, spa establecido. Booking + servicios + mapa.
- Status: **PENDIENTE**
- Sesión sugerida: #10
...
- Stack: **Next.js**
- Notas: 61 reviews, salón de belleza San Lorenzo
- Status: **PENDIENTE**
- Sesión sugerida: #11
...
- Notas: Mejor rating en category make-up. Backup de Leticia.
- Status: **PENDIENTE**
- Sesión sugerida: #12
...
- Notas: Zona norte Fernando, 82 reviews, tattoo establecido
- Status: **PENDIENTE**
- Sesión sugerida: #13
...
- Notas: 377 reviews, 5.0⭐, spa más grande por reviews. Oportunidad premium.
- Status: **PENDIENTE**
- Sesión sugerida: #14
...
- Stack: **Next.js**
- Notas: Misma zona que Estudio Medieval, 66 reviews
- Status: **PENDIENTE**
- Sesión sugerida: #15
...
- Stack: **Next.js**
- Notas: Empresa organizadora de eventos experienciales (Glow Privé Valida), zona premium, no es salón común.
- Status: **PENDIENTE**
- Sesión sugerida: #16
...
- Score: **31.5** | Reviews: 21 | ⭐ 5.0 | Dist: 3.5km
...
```
AL ARRANCAR:
1. Elegir siguiente lead de la cola (top-down)
2. Leer: clientes/[slug]/INTEL.md
3. Leer: proposals/[slug]/PROPUESTA.md
4. Verificar repo en github.com/IvanWeissVanDerPol/[slug]

DURANTE:
5. Clonar repo o trabajar directo en /root/[slug]
6. Build con: nextjs-docker-swarm o sveltekit-static
7. Deploy a: 72.61.44.159 (VPS) o Netlify/surge
8. Verificar: healthcheck + screenshot

AL CERRAR:
9. Commit + push a github.com/IvanWeissVanDerPol/[slug]
10. Actualizar COLA.md → Status: ENTREGADO + link final
11. Notificar a Ivan por Telegram
```

## Stack defaults

| Tipo de negocio | Stack | Notas |
|----------------|-------|-------|
| Barbería | Next.js | Booking + mapa + menú servicios |
| Uñas/Beauty | Next.js | Galería + booking + pos |
| Gym/Fitness | Next.js | Planes + horarios + membership |
| Tattoo | Next.js | Galería + booking + pos |
| Spa | Next.js | Servicios + booking + horarios |
| Makeup | Next.js | Store e-commerce + booking |
| Eventos/Experiential | SvelteKit/Next.js | Landing + galería eventos |

## Deploy targets

- **VPS directo**: 72.61.44.159 (Docker Swarm) — client domains
- **Netlify CLI**: para dominios .com.py bloqueados en CF Pages
- **Surge.sh**: alternativa rápida